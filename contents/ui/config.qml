...
Kirigami.FormLayout {
    ...
    property alias cfg_turnThreshold: turnThresholdSlider.value
    ...
    */
    RowLayout {
        Kirigami.FormData.label: i18n("Fish's Max Speed")
        Slider { id: maxSpeedSlider; from: 0.05; to: 1.0; stepSize: 0.01; Layout.fillWidth: true }
        Label { text: maxSpeedSlider.value.toFixed(2); Layout.preferredWidth: 35 }
    }
    RowLayout {
        Kirigami.FormData.label: i18n("Fish's Min Speed")
        Slider { id: minSpeedSlider; from: 0.01; to: 0.5; stepSize: 0.01; Layout.fillWidth: true }
        Label { text: minSpeedSlider.value.toFixed(2); Layout.preferredWidth: 35 }
    }
    RowLayout {
        Kirigami.FormData.label: i18n("Turn Sensitivity")
        Slider { id: turnThresholdSlider; from: 0.01; to: 1.0; stepSize: 0.01; Layout.fillWidth: true }
        Label { text: turnThresholdSlider.value.toFixed(2); Layout.preferredWidth: 35 }
    }

    RowLayout {
        Kirigami.FormData.label: i18n("Angler Speed")
        Slider { id: anglerSpeedSlider; from: 0.1; to: 2.0; stepSize: 0.01; Layout.fillWidth: true }
        Label { text: anglerSpeedSlider.value.toFixed(2) + "×"; Layout.preferredWidth: 35 }
    }
    RowLayout {
        Kirigami.FormData.label: i18n("Orca Speed")
        Slider { id: orcaSpeedSlider; from: 0.1; to: 2.0; stepSize: 0.01; Layout.fillWidth: true }
        Label { text: orcaSpeedSlider.value.toFixed(2) + "×"; Layout.preferredWidth: 35 }
    }
